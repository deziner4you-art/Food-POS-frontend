    ...
    <div className="animate-fade-in flex flex-col h-[calc(100vh-160px)]">
      ...
      <div className="flex gap-3 mb-6 overflow-x-auto pb-1">
        <button
          ...
          className={`px-5 py-2.5 rounded-xl font-bold transition-all flex items-center gap-2 text-sm ${activeTab === 'MENUS' ? 'bg-stitch-accent text-stitch-accent-ink shadow-lg accent-glow' : 'bg-stitch-panel text-stitch-muted hover:bg-stitch-surface'}`}
        >
          <Store size={16} /> Menu Collections
        </button>
        <button
          onClick={() => setActiveTab('CATEGORIES')}
          className={`px-5 py-2.5 rounded-xl font-bold transition-all flex items-center gap-2 text-sm ${activeTab === 'CATEGORIES' ? 'bg-stitch-accent text-stitch-accent-ink shadow-lg accent-glow' : 'bg-stitch-panel text-stitch-muted hover:bg-stitch-surface'}`}
        >
          <ListTree size={16} /> Categories
        </button>
        <button
          onClick={() => setActiveTab('CATEGORY_GROUPS')}
          className={`px-5 py-2.5 rounded-xl font-bold transition-all flex items-center gap-2 text-sm ${activeTab === 'CATEGORY_GROUPS' ? 'bg-stitch-accent text-stitch-accent-ink shadow-lg accent-glow' : 'bg-stitch-panel text-stitch-muted hover:bg-stitch-surface'}`}
        >
          <Sliders size={16} /> Category Groups
        </button>
        <button
          onClick={() => setActiveTab('PRODUCTS')}
          className={`px-5 py-2.5 rounded-xl font-bold transition-all flex items-center gap-2 text-sm ${activeTab === 'PRODUCTS' ? 'bg-stitch-accent text-stitch-accent-ink shadow-lg accent-glow' : 'bg-stitch-panel text-stitch-muted hover:bg-stitch-surface'}`}
        >
          <Utensils size={16} /> Menu Products
        </button>
        <button
          onClick={() => setActiveTab('MODIFIERS')}
          className={`px-5 py-2.5 rounded-xl font-bold transition-all flex items-center gap-2 text-sm ${activeTab === 'MODIFIERS' ? 'bg-stitch-accent text-stitch-accent-ink shadow-lg accent-glow' : 'bg-stitch-panel text-stitch-muted hover:bg-stitch-surface'}`}
        >
          <Sliders size={16} /> Modifier Groups
        </button>
        <button
          onClick={() => setActiveTab('AVAILABILITY')}
          className={`px-5 py-2.5 rounded-xl font-bold transition-all flex items-center gap-2 text-sm ${activeTab === 'AVAILABILITY' ? 'bg-stitch-accent text-stitch-accent-ink shadow-lg accent-glow' : 'bg-stitch-panel text-stitch-muted hover:bg-stitch-surface'}`}
        >
          <Clock size={16} /> Availability Rules
        </button>
        <button
          onClick={() => setActiveTab('PRODUCT_REQUESTS')}
          className={`px-5 py-2.5 rounded-xl font-bold transition-all flex items-center gap-2 text-sm ${activeTab === 'PRODUCT_REQUESTS' ? 'bg-stitch-accent text-stitch-accent-ink shadow-lg accent-glow' : 'bg-stitch-panel text-stitch-muted hover:bg-stitch-surface'}`}
        >
            ...
            <div className="p-4 border-b border-stitch-border flex justify-between items-center bg-stitch-surface/50">
              ...
              <div className="flex items-center gap-3">
                <select
                  ...
                  className="bg-stitch-card border border-stitch-border rounded-md p-1.5 text-stitch-ink text-sm focus:outline-none focus:border-stitch-accent w-64"
                >
                  ...
                  {selectedCategories.length > 0 && (
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="flex items-center gap-2 bg-stitch-danger/20 hover:bg-stitch-danger/30 text-stitch-danger border border-stitch-danger/50 px-3 py-1.5 rounded-md text-xs font-bold transition-colors"
                      >
                      ...
                      <div className="flex items-center gap-1 border-l border-stitch-border pl-2 ml-2">
                        <select
                          ...
                          className="bg-stitch-card border border-stitch-border rounded-md p-1.5 text-stitch-ink text-xs focus:outline-none focus:border-stitch-accent"
                        >
                        ...
                        {bulkCategoryGroupId > 0 && (
                          <button
                            ...
                            className="bg-stitch-accent hover:bg-stitch-accent-hover text-stitch-accent-ink px-3 py-1.5 rounded-md text-xs font-bold transition-colors"
                          >
                            Apply
                          </button>
                        )}
            ...
            <div className="bg-stitch-surface border-b border-stitch-border p-4 overflow-y-auto max-h-[360px]">
              <form onSubmit={handleProductSubmit} className="flex flex-col gap-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-stitch-card border border-stitch-border rounded-md p-2 text-stitch-ink text-sm focus:outline-none focus:border-stitch-accent"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-stitch-card border border-stitch-border rounded-md p-2 text-stitch-success font-mono font-bold text-sm focus:outline-none focus:border-stitch-accent disabled:opacity-50"
                    />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                  <div className="relative" ref={categoryDropdownRef}>
                    ...
                    <div
                      ...
                      className="w-full bg-stitch-card border border-stitch-border rounded-md p-2 text-stitch-ink text-sm cursor-pointer flex justify-between items-center h-[38px]"
                    >
                    ...
                    {isCategoryDropdownOpen && (
                      <div className="absolute top-[60px] left-0 w-full bg-stitch-card border border-stitch-border rounded-md p-2 text-stitch-ink text-sm max-h-48 overflow-y-auto flex flex-col gap-1 z-50 shadow-xl">
                        {categories.map(c => (
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-stitch-card border border-stitch-border rounded-md p-2 text-stitch-ink text-sm focus:outline-none focus:border-stitch-accent h-[38px]"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3 bg-stitch-card/50 p-3 rounded-lg border border-stitch-border">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-stitch-card border border-stitch-border rounded-md p-2 text-stitch-ink text-sm"
                    />
                  </div>
                  <div>
                      ...
                      {productForm.variants.map((v: any, idx: number) => (
                        <div key={idx} className="flex gap-2 items-center">
                          <input
                            ...
                            className="bg-stitch-card border border-stitch-border rounded-md p-1.5 text-stitch-ink text-xs flex-1"
                          />
                          <input
                            ...
                            className="bg-stitch-card border border-stitch-border rounded-md p-1.5 text-stitch-success font-mono font-bold text-xs w-24"
                          />
                          <input
                            ...
                            className="bg-stitch-card border border-stitch-border rounded-md p-1.5 text-stitch-ink text-xs w-24"
                          />
                          <select
                            ...
                            className="bg-stitch-card border border-stitch-border rounded-md p-1.5 text-stitch-ink text-xs w-36"
                          >
                            <option value={0}>Standard Recipe</option>
                            {recipes.map(r => <option key={r.id} value={r.id}>{r.name}</option>)}
                          </select>
                          <button type="button" onClick={() => { const nv = productForm.variants.filter((_: any, i: number) => i !== idx); setProductForm({...productForm, variants: nv}); }} className="text-stitch-danger p-1.5 hover:bg-stitch-danger/10 rounded-md">
                            <Trash2 size={14} />
                          </button>
                        </div>
                      ))}
                ...
                <div className="flex justify-end gap-3 items-center">
                  ...
                  <button type="submit" className="bg-stitch-accent hover:bg-stitch-accent-hover text-stitch-accent-ink rounded-md px-6 py-2 font-bold text-sm transition-colors flex items-center gap-2 accent-glow-hover">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <div className="relative flex-1 min-w-[200px]">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-1.5 bg-stitch-card border border-stitch-border rounded-md text-stitch-ink text-sm focus:outline-none focus:border-stitch-accent"
                  />
                </div>
                <select
                  value={productFilterMenuId}
                  onChange={e => setProductFilterMenuId(parseInt(e.target.value) || 0)}
                  className="bg-stitch-card border border-stitch-border rounded-md p-1.5 text-stitch-ink text-sm focus:outline-none focus:border-stitch-accent w-48"
                >
                ...
                <select
                  ...
                  className="bg-stitch-card border border-stitch-border rounded-md p-1.5 text-stitch-ink text-sm focus:outline-none focus:border-stitch-accent w-32"
                >
